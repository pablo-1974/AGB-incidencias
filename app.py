...
from routers.profesor_dashboard import router as profesor_dashboard_router
...
from routers.incidents_print import router as incidents_print_router
...
app.include_router(profesor_dashboard_router)
...
app.include_router(incidents_print_router)
